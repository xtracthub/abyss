...
class GZipPredictor(Predictor):
    ...
    @staticmethod
    def train_models(data_path=os.path.join(ROOT_DIR, "../data/gzip_decompression_results.csv"),
                     predictor_save_path=os.path.join(ROOT_DIR, "predictors/models/gzip_predictor_model.pkl"),
                     repredictor_save_path=os.path.join(ROOT_DIR, "predictors/models/gzip_repredictor_model.pkl")) -> None:
    ...
    def load_models(self, predictor_model_path=os.path.join(ROOT_DIR, "predictors/models/gzip_predictor_model.pkl"),
                    repredictor_model_path=os.path.join(ROOT_DIR, "predictors/models/gzip_repredictor_model.pkl")) -> None:
