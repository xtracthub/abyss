...
class JobStatus(Enum):
    ...
    UNPREDICTED_PREDICT = "UNPREDICTED_PREDICT"
    UNPREDICTED_SCHEDULE = "UNPREDICTED_SCHEDULE"
    UNPREDICTED_SCHEDULED = "UNPREDICTED_SCHEDULED"
    UNPREDICTED_PREFETCHING = "UNPREDICTED_PREFETCHING"
    UNPREDICTED_PREFETCHED = "UNPREDICTED_PREFETCHED"
    PROCESSING_HEADERS = "PROCESSING_HEADERS"
    PREDICTED = "PREDICTED"
    SCHEDULED = "SCHEDULED"
