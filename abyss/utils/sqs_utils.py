...
def make_queue(queue_name: str, aws_access: str, aws_secret: str,
               region_name: str):
    """Creates SQS queue.
...
def get_message(queue_name: str, aws_access: str, aws_secret: str,
                region_name: str, max_messages=1) -> List[Dict]:
